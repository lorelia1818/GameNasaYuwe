<?php
   ...
   // Fetch records
   $strQuery = "SELECT u.user_id, u.user_name, u.user_password, u.user_age, u.user_role_user_ro_id, r.user_ro_description FROM usuario u, user_role r WHERE r.user_ro_id = u.user_role_user_ro_id AND r.user_ro_description != 'Administrador' ".$searchQuery." ORDER BY ".$columnName." ".$columnSortOrder." LIMIT :limit,:offset";
   $stmt = $conexion->prepare($strQuery);
   // Bind values
