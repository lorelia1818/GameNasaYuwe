      ...
      $(document).ready(function() {
        var table = $('#render-data').DataTable({
          ...
          responsive: true,
            ...
            'serverMethod': 'post',
            'ajax': {
            'url':'/GameNasaYuwe/nasayuwe/php/usuariodb.php',
            ...
            'columns': [
              ...
              { className: 'dt-center', data: 'user_id',
                          ...
                          return '<a href="usuario.php?user_id='+p_idUsuario+'" data-tip="Modificar"><i class="fa fa-edit" style="font-size:24px"></i></a>';
                        },
