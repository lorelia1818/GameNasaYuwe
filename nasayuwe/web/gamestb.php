          ...
          responsive: true,
            ...
            'columns': [
              ...
              { className: 'dt-center', data: 'game_ty_id', render: function (p_game_ty_id) {
                  return '<a href="/nasayuwe/web/games.php?game_ty_id='+p_game_ty_id+'" data-tip="Modificar"><i class="fa fa-edit" style="font-size:24px"></i></a>';
                },
            ...
            buttons: [
                'excel',  'pdf',
                {
                  ...
                  action: function ( e, dt, node, config ) {
                    window.location = '/nasayuwe/web/games.php';
                  }
                },
                {
